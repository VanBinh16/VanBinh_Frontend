    ...
    <base-material-card color="red">
      ...
      <v-card>
          ...
          <template #[`item.actions`]="{ item }">
            <v-row justify="center" align="center">
              ...
              <tooltip-button
                ...
                iconColor="green"
                :tooltipText="$t('manage_staff_tooltip_create_account')"
                @on-click="openAccountDialog(item)"
              />
            </v-row>
          </template>

          <template #[`item.birthday`]="{ item }">
            {{ dateFormatInput(item.birthday) }}
          </template>
        ...
        <account-dialog
          ...
          :item="accountDialog.item"
          :type="accountDialog.type"
          @close-dialog="accountDialog.show = false"
          @reload-table="getListStaff"
        />
      </v-card>
    </base-material-card>
...
export default {
  ...
  methods: {
    ...
    openAccountDialog: function (item = {}) {
      let type = "create";
      this.accountDialog = { show: true, type, item };
    },
  },
};
</script>
